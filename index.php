					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="admin/images/<?php echo $value['image'] ?>" alt="" style="width:254px; height:254px;">
										 ...
										 <input type="hidden" name="qty" value="1">
											...
											<div class="social-info">
												<button style="display: contents;" class="social-info" type="submit" >
													<span class="ti-bag"></span><p style="left:18px" class="hover-text">  add to bag</p>
												</button>
											</div>
